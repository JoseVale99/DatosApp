                    ...
                    <div class="card-body">
                        ...
                        @endif
                            <div class="form-group row">
                              <label for="inputPassword" class="col-sm-2 col-form-label font-weight-bold">Datos de entrada</label>
                              <div class="col-sm-10">
                                <input type="text" name="dato" class="form-control" placeholder="Ingrese un dato por ej. 3+2">
                              </div>
                            </div>
                              @if (session('message'))
